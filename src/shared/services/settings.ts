...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    {
      name: 'alipay_environment',
      title: 'Alipay Environment',
      type: 'select',
      value: 'production',
      options: [
        { title: 'Sandbox', value: 'sandbox' },
    ...
    },
    {
      ...
      tip: '支付宝开放平台应用的 App ID',
      group: 'alipay',
      tab: 'payment',
    },
    {
      name: 'alipay_private_key',
      title: 'Alipay App Private Key',
      type: 'textarea',
      placeholder: '-----BEGIN PRIVATE KEY-----\n...',
      tip: '应用私钥（PKCS8 格式），在支付宝密钥工具生成后填入',
      attributes: { rows: 6 },
      group: 'alipay',
      tab: 'payment',
    },
    {
      ...
      tip: '支付宝公钥，用于验签，在开放平台管理台上传应用公钥后获取',
      attributes: { rows: 4 },
      group: 'alipay',
      tab: 'payment',
    },
    {
      ...
      title: 'Alipay Notify URL',
      type: 'text',
      placeholder: 'https://yourdomain.com/api/payment/notify/alipay',
      tip: '支付宝异步通知地址，需为公网可访问的 HTTPS 地址',
      group: 'alipay',
      tab: 'payment',
    },
    {
  ...
  },
  {
    ...
    {
      name: 'dify_trial_bots',
      title: 'Trial Bot IDs (open to all users)',
      type: 'text',
      placeholder: '["general-assistant"]',
      group: 'dify',
      tab: 'ai',
      tip: 'JSON array of bot IDs that all registered users can trial. E.g. ["general-assistant"]. Leave empty to disable trial.',
    },
    {
      name: 'dify_trial_quota_tokens',
      title: 'Global Trial Token Quota',
      type: 'text',
      placeholder: '50000',
      group: 'dify',
      tab: 'ai',
      tip: 'Total tokens shared across all trial users. Once exhausted, users see "Contact us for enterprise access".',
    },
    {
...
const ALL_SETTING_NAMES = [
  ...
  'alipay_enabled', 'alipay_environment', 'alipay_app_id', 'alipay_private_key', 'alipay_public_key', 'alipay_notify_url',
  ...
  'dify_api_key', 'dify_api_url', 'dify_bots', 'dify_trial_bots', 'dify_trial_quota_tokens', 'dify_console_email', 'dify_console_password',
