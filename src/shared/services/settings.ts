...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      type: 'url',
      placeholder: 'https://api.nextopenai.com',
      tip: 'OpenAI-compatible base URL. /v1 will be appended if missing.',
      group: 'openai',
      tab: 'ai',
    },
    {
    ...
    },
    {
      ...
      type: 'url',
      placeholder: 'https://api.nextopenai.com',
      tip: 'Anthropic base URL. /v1 will be appended if missing.',
      group: 'anthropic',
      tab: 'ai',
    },
    {
      name: 'anthropic_version',
      title: 'Anthropic API Version',
      type: 'text',
      placeholder: '2023-06-01',
      tip: 'Anthropic API version header',
      group: 'anthropic',
      tab: 'ai',
    },
    {
    ...
    {
      name: 'zhipu_base_url',
      title: 'Zhipu Base URL',
      type: 'url',
      placeholder: 'https://open.bigmodel.cn/api/paas/v4',
      tip: 'Zhipu GLM base URL. /v4 will be appended if missing.',
      group: 'zhipu',
      tab: 'ai',
    },
    {
  ...
  },
  {
    ...
    {
      name: 'dify_console_email',
      title: 'Dify Console Email (for file access)',
      type: 'text',
      placeholder: 'admin@example.com',
      group: 'dify',
      tab: 'ai',
      tip: 'Optional. Dify admin console email. Required to display images from Dify knowledge base.',
    },
    {
      name: 'dify_console_password',
      title: 'Dify Console Password',
      type: 'password',
      placeholder: '••••••',
      group: 'dify',
      tab: 'ai',
      tip: 'Optional. Dify admin console password. Used together with email to access knowledge base files.',
    },
    {
