...
POST
/files/upload
curl -X POST 'http://156.224.28.114/v1/files/upload' \
--header 'Authorization: Bearer {api_key}' \
...
GET
/files/:file_id/preview
curl -X GET 'http://156.224.28.114/v1/files/72fa9618-8f89-4a37-9b33-7e1178a24a67/preview' \
--header 'Authorization: Bearer {api_key}'
...
curl -X GET 'http://156.224.28.114/v1/files/72fa9618-8f89-4a37-9b33-7e1178a24a67/preview?as_attachment=true' \
--header 'Authorization: Bearer {api_key}' \
...
POST
/chat-messages/:task_id/stop
curl -X POST 'http://156.224.28.114/v1/chat-messages/:task_id/stop' \
...
POST
/messages/:message_id/feedbacks
curl -X POST 'http://156.224.28.114/v1/messages/:message_id/feedbacks' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{
  "rating": "like",
...
GET
/app/feedbacks
curl -X GET 'http://156.224.28.114/v1/app/feedbacks?page=1&limit=20' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json'
...
GET
/messages/{message_id}/suggested
curl --location --request GET 'http://156.224.28.114/v1/messages/{message_id}/suggested?user=abc-123' \
...
GET
/messages
curl -X GET 'http://156.224.28.114/v1/messages?user=abc-123&conversation_id={conversation_id}'
--header 'Authorization: Bearer {api_key}'
...
GET
/conversations
curl -X GET 'http://156.224.28.114/v1/conversations?user=abc-123&last_id=&limit=20' \
--header 'Authorization: Bearer {api_key}'
...
DELETE
/conversations/:conversation_id
curl -X DELETE 'http://156.224.28.114/v1/conversations/{conversation_id}' \
--header 'Content-Type: application/json' \
...
POST
/conversations/:conversation_id/name
curl -X POST 'http://156.224.28.114/v1/conversations/{conversation_id}/name' \
--header 'Content-Type: application/json' \
--header 'Authorization: Bearer {api_key}' \
--data-raw '{
  "name": "",
...
GET
/conversations/:conversation_id/variables
curl -X GET 'http://156.224.28.114/v1/conversations/{conversation_id}/variables?user=abc-123' \
--header 'Authorization: Bearer {api_key}'

Copy
Copied!
带变量名过滤的请求
curl -X GET 'http://156.224.28.114/v1/conversations/{conversation_id}/variables?user=abc-123&variable_name=customer_name' \
--header 'Authorization: Bearer {api_key}'
...
PUT
/conversations/:conversation_id/variables/:variable_id
curl -X PUT 'http://156.224.28.114/v1/conversations/{conversation_id}/variables/{variable_id}' \
--header 'Content-Type: application/json' \
--header 'Authorization: Bearer {api_key}' \
--data-raw '{
  "value": "Updated Value",
...
POST
/audio-to-text
curl -X POST 'http://156.224.28.114/v1/audio-to-text' \
--header 'Authorization: Bearer {api_key}' \
...
POST
/text-to-audio
curl -o text-to-audio.mp3 -X POST 'http://156.224.28.114/v1/text-to-audio' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{
...
GET
/info
curl -X GET 'http://156.224.28.114/v1/info' \
-H 'Authorization: Bearer {api_key}'
...
GET
/parameters
curl -X GET 'http://156.224.28.114/v1/parameters'
...
GET
/meta
curl -X GET 'http://156.224.28.114/v1/meta' \
-H 'Authorization: Bearer {api_key}'
...
GET
/site
curl -X GET 'http://156.224.28.114/v1/site' \
-H 'Authorization: Bearer {api_key}'
...
GET
/apps/annotations
curl --location --request GET 'http://156.224.28.114/v1/apps/annotations?page=1&limit=20' \
--header 'Authorization: Bearer {api_key}'
...
POST
/apps/annotations
curl --location --request POST 'http://156.224.28.114/v1/apps/annotations' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{
  "question": "What is your name?",
...
PUT
/apps/annotations/{annotation_id}
curl --location --request PUT 'http://156.224.28.114/v1/apps/annotations/{annotation_id}' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{
  "question": "What is your name?",
...
DELETE
/apps/annotations/{annotation_id}
curl --location --request DELETE 'http://156.224.28.114/v1/apps/annotations/{annotation_id}' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json'
...
POST
/apps/annotation-reply/{action}
curl --location --request POST 'http://156.224.28.114/v1/apps/annotation-reply/{action}' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{
  "score_threshold": 0.9,
...
GET
/apps/annotations
curl --location --request GET 'http://156.224.28.114/v1/apps/annotation-reply/{action}/status/{job_id}' \
--header 'Authorization: Bearer {api_key}'
